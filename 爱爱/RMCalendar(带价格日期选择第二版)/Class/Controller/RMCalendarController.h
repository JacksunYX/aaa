...
//多个时间模型的回调代码
typedef void (^CalendarArrBlock)(NSMutableArray *arr);
/**
 *  起始页面
 */
 ...
 *  多个日期对象回调
 */
@property (nonatomic, copy) CalendarArrBlock  calendarArrblock; //数组时间的回调
/**
 *  天数
 */
...
@property (nonatomic,strong) NSArray *haveSelectrdDateArr;
