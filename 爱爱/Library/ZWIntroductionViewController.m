...
- (void)viewDidLoad {
    ...
    if (!self.enterButton) {
        ...
        self.enterButton.layer.borderWidth = 0.4;
...
- (CGRect)frameOfEnterButton
{
    ...
    return CGRectMake(self.view.frame.size.width / 2 - size.width / 2, self.pageControl.frame.origin.y - size.height+15, size.width, size.height);
}
