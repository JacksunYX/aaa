...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        for (NSInteger index = 0; index < separateLabelCount; index ++) {
            ...
            if (_separateLabelColor) {
                
                separateLabel.textColor = _separateLabelColor;
...
- (void)layoutSubviews{
    ...
    if (_dayTextColor) {
        ...
        _dayLabel.textColor = _dayTextColor;
        
    }
    if (_hourTextColor) {
        
        _hourLabel.textColor = _hourTextColor;
        
    }
    if (_minuteTextColor) {
        
        _minuesLabel.textColor = _minuteTextColor;
        
    }
    if (_secondsTextColor) {
        
        _secondsLabel.textColor = _secondsTextColor;
