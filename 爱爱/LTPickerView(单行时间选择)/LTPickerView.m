...
#define ControlViewHeight   230   //视图的高度
...
-(void)loadUI{
    ...
    self.frame = CGRectMake(0, Screen_Height, Screen_Width, ControlViewHeight);
}
...
//    [self.layer pop_addAnimation:animation forKey:@"pop"];
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.frame = CGRectMake(0, Screen_Height - ControlViewHeight, Screen_Width, ControlViewHeight);
    }];
