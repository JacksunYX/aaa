...
//    NSLog(@"udUserChoose:%d",udUserChoose);
    //时间戳的天数
...
-(void)alertUserCommentView:(UIViewController *)VC{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0) {
        ...
        alertController = [UIAlertController alertControllerWithTitle:@"感谢您~" message:@"有了您的支持我们才能更好的为您服务，提供更优质、更适合您的App，当然您也可以直接向我们反馈问题" preferredStyle:(UIAlertControllerStyleAlert)];
